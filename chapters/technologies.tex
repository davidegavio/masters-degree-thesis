...
Examples of DFS are:
\begin{itemize}
    \item Google File System (GFS) \cite{GhemawatSanjay2003TheGF}, the first of the class
    \item Hadoop Distributed File System (HDFS) \cite{Shvachko2010TheHD}, an open-source DFS used with Hadoop
